...
public class CSDLHoaHoc extends SQLiteOpenHelper {
    public String DB_PATH = "data/data/anhnguyen.com.vn.starstudy/";
    private static final String DATABASE_NAME = "HoaHoc.sqlite";
    //    private static final int DATABASE_VERSION = 1;
    private static final String TABLE_NAME = "HoaHoc";
    private SQLiteDatabase csdlHoaHoc;
    private Context context;

    public CSDLHoaHoc(Context context) {
    ...
    public SQLiteDatabase getCsdlHoaHoc() {
        return csdlHoaHoc;
    }
...
//        String outFileName = DB_PATH + DATABASE_NAME;
        ...
        OutputStream myOutput = new FileOutputStream("data/data/anhnguyen.com.vn.starstudy/HoaHoc.sqlite");
    ...
    public void open() {
        String myPath = DB_PATH + DATABASE_NAME;
        csdlHoaHoc = SQLiteDatabase.openDatabase(myPath, null, SQLiteDatabase.OPEN_READONLY);
    }
    ...
    public static class executeCSDLHoaHoc extends CSDLMonHoc {
        private Context context;
        private int[] dsViTriCauHoi;
        private SQLiteDatabase db;

        public executeCSDLHoaHoc(Context context) {
            this.context = context;
        }

        public String[] layDeThi(int number_Question) {
            CSDLHoaHoc csdlHoaHoc = new CSDLHoaHoc(context);
            csdlHoaHoc.open();
            this.db = csdlHoaHoc.getCsdlHoaHoc();
